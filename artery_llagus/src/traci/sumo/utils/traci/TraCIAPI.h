...
public:
    ...
    */
    ...
    public:
        ...
        // @Aniol
        void my_changeLane(const std::string& vehicleID, char lane, int duration) const;
        std::string my_getLaneID(const std::string& vehicleID) const;
        int my_getLaneIndex(const std::string& vehicleID) const;
        void my_slowDown(const std::string& vehicleID, int when) const;
        void my_changeColor(const std::string& vehicleID) const;
        double my_getSpeed(const std::string& vehicleID) const;
        void my_setSpeed(const std::string& vehicleID, int) const;
