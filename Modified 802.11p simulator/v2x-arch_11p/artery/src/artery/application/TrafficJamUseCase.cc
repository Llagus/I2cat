...
bool TrafficJamAhead::checkPreconditions()
{
    ...
    //EV_WARN << "    --> PreCondition: trafficJamAhead [mNonUrbanEnvironment] ....... " << mNonUrbanEnvironment << endl;
...
bool TrafficJamAhead::checkConditions()
{
    ...
    //EV_WARN << "    --> Condition: trafficJamAhead.checkLowAverageEgoVelocity() .... " << tc0() << endl;
    //EV_WARN << "    --> Condition: trafficJamAhead.checkStationaryEgo() ............ " << tc1() << endl;
    //EV_WARN << "    --> Condition: trafficJamAhead.checkTrafficJamAheadReceived() .. " << tc2() << endl;
    //EV_WARN << "    --> Condition: trafficJamAhead.checkSlowVehiclesAheadByV2X() ... " << tc4() << endl;
